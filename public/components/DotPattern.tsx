...
const DotPatternSvg = `
<svg viewBox="0 0 389 404" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const DotPattern: React.FC<{ className?: string }> = (props) => {
  console.log(
    `data:image/svg+xml;base64,${Buffer.from(DotPatternSvg, 'utf-8').toString(
      'base64',
    )}`,
  );
  return (
